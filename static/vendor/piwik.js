            ...
            if (!af) {
              ...
              m = function (aj, an) {
                var am = u.call(aj) == U,
                  ...
                  ak;
                var ai =
                  (!am && typeof aj.constructor != 'function' && e[typeof aj.hasOwnProperty] && aj.hasOwnProperty) || r;
                for (al in aj) {
              ...
              if (typeof at == 'object' && at) {
                ...
                if (ae == Q && !r.call(at, 'toJSON')) {
                  if (at > -1 / 0 && at < 1 / 0) {
                    ...
                    at =
                      (ap <= 0 || ap >= 10000 ? (ap < 0 ? '-' : '+') + t(6, ap < 0 ? -ap : ap) : t(4, ap)) +
                      '-' +
                      t(2, az + 1) +
                      '-' +
                      t(2, ay) +
  ...
  window.Matomo = window.Piwik = (function () {
    ...
    function Q(ce, b9) {
      ...
      function cS() {
        var dl = cI();
        return b7(
          (h.userAgent || '') + (h.platform || '') + JSON_PIWIK.stringify(dl) + new Date().getTime() + Math.random()
        ).slice(0, 16);
      }
      function aA() {
        var dl = cI();
      ...
      function ct(dn, dJ, dK, dp) {
        ...
        dn +=
          ...
          '&_viewts=' +
          dC.lastVisitTs +
          (String(dC.lastEcommerceOrderTs).length ? '&_ects=' + dC.lastEcommerceOrderTs : '') +
      ...
      function b8(dl, dp, dm, dq) {
        var dn = ct(
          'search=' + t(dl) + (dp ? '&search_cat=' + t(dp) : '') + (J(dm) ? '&search_count=' + dm : ''),
          dq,
          'sitesearch'
        );
        bF(dn, bJ);
